...
- `PUT|DELETE /internal/accounts/{username}`、`PUT /internal/accounts/{username}/buckets`、`GET /internal/api-access`、`GET|POST /internal/api-access/{username}/...`、`POST /internal/buckets/{bucket_name}/inventory`、`/internal/accounts/{username}/rbac/...`、`PUT /internal/settings`（运营投影，Bearer `PROJECTION_SECRET`）
